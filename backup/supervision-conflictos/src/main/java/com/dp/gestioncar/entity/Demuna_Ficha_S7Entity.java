...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "car_ficha_s7", schema = "SIGA")
...
public class Demuna_Ficha_S7Entity implements Serializable {
    ...
    @Column(name = "p7_2_hora", length = 5)
    private String p7_2_hora; 
    
    private String p7_3;
    private String p7_4_hora;
    private String p7_5;
    private String p7_6;
    private String p7_6_otro;
    private String p7_7;
    private String p7_8;
    private String p7_8_otro;
    private String p7_9_otro;
    private String p7_9;
    private String p7_10;
