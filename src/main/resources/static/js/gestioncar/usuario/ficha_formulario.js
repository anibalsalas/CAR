...
$(document).ready(function () {
   ...
   $(document).on('submit', '#frm_mdl_sec4_3', function (event) {
    ...
    $(document).on('submit', '#frm_mdl_sec4_4', function (event) {
        event.preventDefault();

        guardar_modal_sec4_4();
...
$(document).on('submit', '#frm_mdl_sec1_6', function (event) {
        event.preventDefault();
        guardar_modal_sec1_6();

    });
    
  $(document).on('submit', '#frm_mdl_sec3_2', function (event) {
        event.preventDefault();
        guardar_modal_sec3_2();

    });  
 
 
   $(document).on('submit', '#frm_mdl_sec3_3', function (event) {
        event.preventDefault();
        guardar_modal_sec3_3();

    });  
    
    
 $(document).on('submit', '#frm_mdl_sec4_2', function (event) {
        event.preventDefault();
        guardar_modal_sec4_2();

    });  
 
 $(document).on('submit', '#frm_mdl_sec6_1', function (event) {
        event.preventDefault();
        guardar_modal_sec6_1();

    });  
    
 $(document).on('submit', '#frm_mdl_sec9_1', function (event) {
    event.preventDefault();
    guardar_modal_sec9_1();
...
function guardar_modal_sec1_6() {
    ...
    var car_ficha_s1_p1_6pk = {
        id: parseInt($("#mdl_sec1_6_id").val()),
        id_ficha: parseInt($("#mdl_sec1_6_id_ficha").val())
    };

    console.log("1");
    var car_ficha_s1_p1_6 = {
        car_ficha_s1_p1_6pk: car_ficha_s1_p1_6pk,
    ...
    $.ajax({
        ...
        contentType: "application/json;text/html;charset=UTF-8",
        type: "POST",
        data: JSON.stringify(car_ficha_s1_p1_6),
        success: function (data, textStatus, jqXHR) {
            console.log("3");
...
if (siRadio.checked){
    ...
    var radios = document.querySelectorAll('.check_p2_8');
        radios.forEach(function (radio) {
            radio.disabled = false;
            radio.required = true;
        });
...
function guardar_modal_sec3_2() {
    ...
    var car_ficha_s3_p3_2pk = {
        id: parseInt($("#mdl_sec3_2_id").val()),
        id_ficha: parseInt($("#mdl_sec3_2_id_ficha").val())
    };

    console.log("1");
    var car_ficha_s3_p3_2 = {
        car_ficha_s3_p3_2pk: car_ficha_s3_p3_2pk,
    ...
    $.ajax({
        ...
        contentType: "application/json;text/html;charset=UTF-8",
        type: "POST",
        data: JSON.stringify(car_ficha_s3_p3_2),
        success: function (data, textStatus, jqXHR) {
            console.log("3");
...
function guardar_modal_sec3_3() {
    ...
    var car_ficha_s3_p3_3pk = {
        id: parseInt($("#mdl_sec3_3_id").val()),
        id_ficha: parseInt($("#mdl_sec3_3_id_ficha").val())
    };

    console.log("1");
    var car_ficha_s3_p3_3 = {
        car_ficha_s3_p3_3pk: car_ficha_s3_p3_3pk,
    ...
    $.ajax({
        ...
        contentType: "application/json;text/html;charset=UTF-8",
        type: "POST",
        data: JSON.stringify(car_ficha_s3_p3_3),
        success: function (data, textStatus, jqXHR) {
            console.log("3");
...
function guardar_modal_sec4_2() {
    ...
    var car_ficha_s4_p4_2pk = {
        id: parseInt($("#mdl_sec4_2_id").val()),
        id_ficha: parseInt($("#mdl_sec4_2_id_ficha").val())
    };

    console.log("1");
    var car_ficha_s4_p4_2 = {
        car_ficha_s4_p4_2pk: car_ficha_s4_p4_2pk,
    ...
    $.ajax({
        ...
        contentType: "application/json;text/html;charset=UTF-8",
        type: "POST",
        data: JSON.stringify(car_ficha_s4_p4_2),
        success: function (data, textStatus, jqXHR) {
            console.log("3");
...
function guardar_modal_sec4_4() {
    ...
    var car_ficha_s4_p4_4pk = {
        id: parseInt($("#mdl_sec4_4_id").val()),
        id_ficha: parseInt($("#mdl_sec4_4_id_ficha").val())
    };

    console.log("1");
    var car_ficha_s4_p4_4 = {
        car_ficha_s4_p4_4pk: car_ficha_s4_p4_4pk,
    ...
    $.ajax({
        ...
        contentType: "application/json;text/html;charset=UTF-8",
        type: "POST",
        data: JSON.stringify(car_ficha_s4_p4_4),
        success: function (data, textStatus, jqXHR) {
            console.log("3");
...
function guardar_modal_sec6_1() {
    ...
    var car_ficha_s6_p6_1pk = {
        id: parseInt($("#mdl_sec6_1_id").val()),
        id_ficha: parseInt($("#mdl_sec6_1_id_ficha").val())
    };

    console.log("1");
    var car_ficha_s6_p6_1 = {
        car_ficha_s6_p6_1pk: car_ficha_s6_p6_1pk,
    ...
    $.ajax({
        ...
        contentType: "application/json;text/html;charset=UTF-8",
        type: "POST",
        data: JSON.stringify(car_ficha_s6_p6_1),
        success: function (data, textStatus, jqXHR) {
            console.log("3");
...
function valida_p8_1_deshabilita_radios() {
 ...
 function valida_p8_6_deshabilita_radios() {
    ...
    const radios = document.querySelectorAll('.row87 input[type="radio"]');
...
function guardar_modal_sec9_1() {
    ...
    var car_ficha_s9_p9_1pk = {
        id: parseInt($("#mdl_sec9_1_id").val()),
        id_ficha: parseInt($("#mdl_sec9_1_id_ficha").val())
    };

    console.log("1");
    var car_ficha_s9_p9_1 = {
        car_ficha_s9_p9_1pk: car_ficha_s9_p9_1pk,
    ...
    $.ajax({
        ...
        contentType: "application/json;text/html;charset=UTF-8",
        type: "POST",
        data: JSON.stringify(car_ficha_s9_p9_1),
        success: function (data, textStatus, jqXHR) {
            console.log("3");
...
function valida_p10_1_15_malo() {
    ...
    // Lógica para habilitar/deshabilitar solo si no hay archivos en la tabla
    if (!hasFiles) {
        rowElements.forEach(function (element) {
            element.disabled = !isMaloSelected; // Cambiar estado solo si no hay archivos
...
function valida10318() {
 ...
 const operativosRadios = document.querySelectorAll('.row10319_extend input[type="radio"]');
...
////////////////////////////////////////////////////////////////////////////////
 ...
 function valida_p10_3_26_otro(){
    var otroRadio = document.getElementById('p10_3_26_e');
...
function valida10325() {
 ...
 const operativosRadios = document.querySelectorAll('.row10326 input[type="radio"]');
 var otro= document.getElementById('p10_3_26_otro');
...
function valida10327() {
 ...
 const operativosRadios = document.querySelectorAll('.row10328 input[type="radio"]');
