...
import com.dp.gestioncar.repository.Car_Ficha_S1_6Repository;
import com.dp.gestioncar.repository.Car_Ficha_S3_2Repository;
import com.dp.gestioncar.repository.Car_Ficha_S3_3Repository;
import com.dp.gestioncar.repository.Car_Ficha_S4_2Repository;
import com.dp.gestioncar.repository.Car_Ficha_S4_4Repository;
import com.dp.gestioncar.repository.Car_Ficha_S6_1Repository;
import com.dp.gestioncar.repository.Car_Ficha_S9_1Repository;
import com.dp.gestioncar.repository.Demuna_ArchivoRepository;
...
public class Demuna_FichaDAOImpl implements Demuna_FichaDAO {
   ...
   @Autowired
    ...
    Car_Ficha_S1_3Repository car_ficha_s1_3Repository;
     ...
     @Autowired
    Car_Ficha_S1_6Repository car_ficha_s1_6Repository;
     
    @Autowired
    Car_Ficha_S3_2Repository car_ficha_s3_2Repository;
   ...
   @Autowired
    ...
    @Autowired
    Car_Ficha_S3_3Repository car_ficha_s3_3Repository;
    
      @Autowired
    Car_Ficha_S4_2Repository car_ficha_s4_2Repository;
      
        @Autowired
    Car_Ficha_S4_4Repository car_ficha_s4_4Repository;
        
    @Autowired
    Car_Ficha_S9_1Repository car_ficha_s9_1Repository;
        
         
         @Autowired
    Car_Ficha_S6_1Repository car_ficha_s6_1Repository;
...
public Integer generarIdS1_6(Integer id_ficha) {
    return car_ficha_s1_6Repository.generarIdS1_6(id_ficha);
}

@Override
public List<Car_Ficha_S1_P1_6Entity> listarS1_6ByIdFicha(Integer id_ficha) {
    return car_ficha_s1_6Repository.listarS1_6ByIdFichaGrupo(id_ficha);
}

@Override
public void guardarFichaS1_6(Car_Ficha_S1_P1_6Entity car_ficha_s1_p1_6) {
    car_ficha_s1_6Repository.save(car_ficha_s1_p1_6);
}

@Override
public void eliminarFichaS1_6(Car_Ficha_S1_P1_6PkEntity car_ficha_s1_p1_6pk) {
    car_ficha_s1_6Repository.deleteById(car_ficha_s1_p1_6pk);
}

@Override
public Car_Ficha_S1_P1_6Entity getFicha_S1_6ById(Car_Ficha_S1_P1_6PkEntity car_ficha_s1_p1_6pk) {
    return car_ficha_s1_6Repository.getReferenceById(car_ficha_s1_p1_6pk);
    }
...
public Integer generarIdS3_2(Integer id_ficha) {
    return car_ficha_s3_2Repository.generarIdS3_2(id_ficha);
}

@Override
public List<Car_Ficha_S3_P3_2Entity> listarS3_2ByIdFicha(Integer id_ficha) {
    return car_ficha_s3_2Repository.listarS3_2ByIdFichaGrupo(id_ficha);
}

@Override
public void guardarFichaS3_2(Car_Ficha_S3_P3_2Entity car_ficha_s3_p3_2) {
    car_ficha_s3_2Repository.save(car_ficha_s3_p3_2);
}

@Override
public void eliminarFichaS3_2(Car_Ficha_S3_P3_2PkEntity car_ficha_s3_p3_2pk) {
    car_ficha_s3_2Repository.deleteById(car_ficha_s3_p3_2pk);
}

@Override
public Car_Ficha_S3_P3_2Entity getFicha_S3_2ById(Car_Ficha_S3_P3_2PkEntity car_ficha_s3_p3_2pk) {
    return car_ficha_s3_2Repository.getReferenceById(car_ficha_s3_p3_2pk);
    }
...
public Integer generarIdS6_1(Integer id_ficha) {
    return car_ficha_s6_1Repository.generarIdS6_1(id_ficha);
}

@Override
public List<Car_Ficha_S6_P6_1Entity> listarS6_1ByIdFicha(Integer id_ficha) {
    return car_ficha_s6_1Repository.listarS6_1ByIdFichaGrupo(id_ficha);
}

@Override
public void guardarFichaS6_1(Car_Ficha_S6_P6_1Entity car_ficha_s6_p6_1) {
    car_ficha_s6_1Repository.save(car_ficha_s6_p6_1);
}

@Override
public void eliminarFichaS6_1(Car_Ficha_S6_P6_1PkEntity car_ficha_s6_p6_1pk) {
    car_ficha_s6_1Repository.deleteById(car_ficha_s6_p6_1pk);
}

@Override
public Car_Ficha_S6_P6_1Entity getFicha_S6_1ById(Car_Ficha_S6_P6_1PkEntity car_ficha_s6_p6_1pk) {
    return car_ficha_s6_1Repository.getReferenceById(car_ficha_s6_p6_1pk);
    }
 ///////////////////////////////////////////////////////////////////////////////

    @Override
    public Integer generarIdS3_3(Integer id_ficha) {
        return car_ficha_s3_3Repository.generarIdS3_3(id_ficha);
    }

    @Override
    public List<Car_Ficha_S3_P3_3Entity> listarS3_3ByIdFicha(Integer id_ficha) {
        return car_ficha_s3_3Repository.listarS3_3ByIdFichaGrupo(id_ficha);
    }

    @Override
    public void guardarFichaS3_3(Car_Ficha_S3_P3_3Entity car_ficha_s3_p3_3) {
        car_ficha_s3_3Repository.save(car_ficha_s3_p3_3);
    }

    @Override
    public void eliminarFichaS3_3(Car_Ficha_S3_P3_3PkEntity car_ficha_s3_p3_3pk) {
        car_ficha_s3_3Repository.deleteById(car_ficha_s3_p3_3pk);
    }

    @Override
    public Car_Ficha_S3_P3_3Entity getFicha_S3_3ById(Car_Ficha_S3_P3_3PkEntity car_ficha_s3_p3_3pk) {
        return car_ficha_s3_3Repository.getReferenceById(car_ficha_s3_p3_3pk);
        }  
    ...
    public Integer generarIdS4_2(Integer id_ficha) {
        return car_ficha_s4_2Repository.generarIdS4_2(id_ficha);
    }

    @Override
    public List<Car_Ficha_S4_P4_2Entity> listarS4_2ByIdFicha(Integer id_ficha) {
        return car_ficha_s4_2Repository.listarS4_2ByIdFichaGrupo(id_ficha);
    }

    @Override
    public void guardarFichaS4_2(Car_Ficha_S4_P4_2Entity car_ficha_s4_p4_2) {
        car_ficha_s4_2Repository.save(car_ficha_s4_p4_2);
    }

    @Override
    public void eliminarFichaS4_2(Car_Ficha_S4_P4_2PkEntity car_ficha_s4_p4_2pk) {
        car_ficha_s4_2Repository.deleteById(car_ficha_s4_p4_2pk);
    }

    @Override
    public Car_Ficha_S4_P4_2Entity getFicha_S4_2ById(Car_Ficha_S4_P4_2PkEntity car_ficha_s4_p4_2pk) {
        return car_ficha_s4_2Repository.getReferenceById(car_ficha_s4_p4_2pk);
        }  
    ...
    public Integer generarIdS4_4(Integer id_ficha) {
        return car_ficha_s4_4Repository.generarIdS4_4(id_ficha);
    }

    @Override
    public List<Car_Ficha_S4_P4_4Entity> listarS4_4ByIdFicha(Integer id_ficha) {
        return car_ficha_s4_4Repository.listarS4_4ByIdFichaGrupo(id_ficha);
    }

    @Override
    public void guardarFichaS4_4(Car_Ficha_S4_P4_4Entity car_ficha_s4_p4_4) {
        car_ficha_s4_4Repository.save(car_ficha_s4_p4_4);
    }

    @Override
    public void eliminarFichaS4_4(Car_Ficha_S4_P4_4PkEntity car_ficha_s4_p4_4pk) {
        car_ficha_s4_4Repository.deleteById(car_ficha_s4_p4_4pk);
    }

    @Override
    public Car_Ficha_S4_P4_4Entity getFicha_S4_4ById(Car_Ficha_S4_P4_4PkEntity car_ficha_s4_p4_4pk) {
        return car_ficha_s4_4Repository.getReferenceById(car_ficha_s4_p4_4pk);
        }  
////////////////////////////////////////////////////////////////////////////////////
     ///////////////////////////////////////////////////////////////////////////////
 ...
 public Integer generarIdS9_1(Integer id_ficha) {
     return car_ficha_s9_1Repository.generarIdS9_1(id_ficha);
 }

 @Override
 public List<Car_Ficha_S9_P9_1Entity> listarS9_1ByIdFicha(Integer id_ficha) {
     return car_ficha_s9_1Repository.listarS9_1ByIdFichaGrupo(id_ficha);
 }

 @Override
 public void guardarFichaS9_1(Car_Ficha_S9_P9_1Entity car_ficha_s9_p9_1) {
     car_ficha_s9_1Repository.save(car_ficha_s9_p9_1);
 }

 @Override
 public void eliminarFichaS9_1(Car_Ficha_S9_P9_1PkEntity car_ficha_s9_p9_1pk) {
     car_ficha_s9_1Repository.deleteById(car_ficha_s9_p9_1pk);
 }

 @Override
 public Car_Ficha_S9_P9_1Entity getFicha_S9_1ById(Car_Ficha_S9_P9_1PkEntity car_ficha_s9_p9_1pk) {
     return car_ficha_s9_1Repository.getReferenceById(car_ficha_s9_p9_1pk);
     }  
